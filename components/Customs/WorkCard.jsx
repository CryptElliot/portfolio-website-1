...
const WorkCard = (props) => {
    ...
    return (
        <div className="flex-grow bg-paper p-3 mb-3 mx-3 md:mx-2 shadow-normal rounded-lg overflow-hidden">
            ...
            <div className="pt-4">
                ...
                <h1 className="title-font text-lg capitalize font-bold text-textPrimary  mb-2">
                    {title}
                </h1>
                <p className="text-xs leading-relaxed text-textSecondary  mb-3">
                    {description}
                </p>
                ...
                <div className="flex items-center flex-nowrap">
                    <a href={codeURL} className="inline-flex w-full shadow-normal justify-center items-center cursor-pointer transition-all duration-300 py-2 px-3 text-md font-md text-center rounded-lg outline-none text-textPrimary/60   bg-black/5 dark:bg-white/5 hover:bg-primary dark:hover:bg-primary hover:text-white dark:hover:text-white mr-2">
                        <HiOutlineCode className="w-4 h-4 stroke-[3px]" />
                    </a>
                    <a href={demoURL} className="inline-flex w-full justify-center shadow-normal items-center cursor-pointer transition-all duration-300 py-2 px-3 text-md font-md text-center rounded-lg outline-none text-textPrimary/60   bg-black/5 dark:bg-white/5 hover:bg-primary dark:hover:bg-primary hover:text-white dark:hover:text-white">

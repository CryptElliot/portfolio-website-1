...
const TestimonialCard = (props) => {
    ...
    return (
        <div className="md:w-1/2 w-full h-full">
            <div className="p-6 m-2 rounded-lg bg-paper shadow-normal">

                <div className="rounded-lg relative">

                    <p className="text-xs md:text-sm tracking-wider capitalize text-textPrimary/60">
                        {content}
                    </p>
                    ...
                    <div className='flex items-center xs:flex-row flex-col pt-4'>
                        <div className='flex items-center flex-grow mb-1 xs:mb-0 w-full'>
                            ...
                            <div className='mx-4 w-full'>
                                ...
                                <p className="text-xs tracking-wider font-extralight capitalize text-textSecondary ">
                                    {author.description}
                                </p>
                            </div>
                        </div>

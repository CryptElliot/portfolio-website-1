...
const Section = (props) => {
    ...
    return (
        <section id={id ? id : ""} className={`${className ? className : ''} py-5 xs:py-10 px-4 md:py-16 md:px-7 bg-default  body-font`}>
            {(subtitle || title || description) && <div className='flex flex-col text-center lg:max-w-[500px] m-auto mb-4 xs:mb-10 px-1'>
                ...
                {description && <p className="text-sm capitalize text-textSecondary /60">{description}</p>}
            </div>}

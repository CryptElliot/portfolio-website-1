...
const ServiceCard = (props) => {
    ...
    return (
        ...
        <div className="select-none relative m-2 z-20 shadow-normal bg-paper hover:bg-primary dark:hover:bg-primary overflow-hidden text-center rounded-xl cursor-default transition duration-300 group">
            <div className='p-6 flex justify-center flex-col'>
                ...
                <p className="text-xs capitalize opacity-80 transition duration-300 text-textSecondary  group-hover:text-white">
                    {description}
                </p>
            </div>
